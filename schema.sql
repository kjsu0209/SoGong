...
CREATE TABLE PARKING (
	...
	fee number,
	Adr varchar2(100),
	CONSTRAINT asker FOREIGN KEY (User_ID) REFERENCES USER_sp(id)
);
...
INSERT INTO PARKING_PLACE VALUES (0, 'kim','Kyungpook University',4000);
INSERT INTO PARKING_PLACE VALUES (1, 'kim','KT company',5000);
